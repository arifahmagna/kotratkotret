...
<head>
    ...
    <style>
        ...
        .floating-label input, .floating-label select { padding-top: 20px; padding-bottom: 8px; padding-left: 20px; background-color: #252836  !important; color: white; }
