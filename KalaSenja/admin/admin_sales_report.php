...
.container-button a .revenue,
.container-button a .wallet,
.container-button a .menu-sales {
    font-size: 2em;
    color: #fff;
    margin-bottom: 10px;
    text-decoration: none;
...
<body>
    ...
    <aside class="sidebar">
        ...
        <a href="../admin/admin_sales_report.php">
            <div class="sidebar-icon active" data-icon="report"><i class="ph ph-chart-line-up"></i></div>
        </a>
    ...
    <div class="container">
        <main id="users" class="content-section active">
            ...
            <div class="container-button">
                <a href="../view/admin_revenue.php">
                    <div class="revenue">
                        <i class="ph ph-projector-screen-chart"></i>
                        <p style="font-size: 1rem;">Revenue</p>
                    </div>
                </a>
                <a href="../view/admin_dompet.php">
                    <div class="wallet">
                        <i class="ph ph-wallet"></i>
                        <p style="font-size: 1rem;">Wallet</p>
                    </div>
                </a>
                <a href="../view/admin_menu_sales.php">
                    <div class="menu-sales">
                        <i class="ph ph-coffee"></i>
                        <p style="font-size: 1rem;">Menu Sales</p>
                    </div>
                </a>
            </div>
        </main>
