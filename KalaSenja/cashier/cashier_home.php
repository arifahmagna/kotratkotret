...
// Query untuk mengambil nilai id_tmu dan animal_tmu berdasarkan id_tmu
...
<body>
            ...
            <header>
                ...
                <?php
                        ...
                        if (is_null($animal_tmu)) {
                            echo '<a href="../update/update_profile.php">
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        if ($row['stock_tmm'] > 0) {
                            ...
                            echo "<button class='add-cart-btn' onclick='outOfStockAlert()' style='background-color: #a1a1a1; cursor: not-allowed;'>Out of Stock</button>";
                        }
    ...
    <script>
        ...
        Swal.fire({
            icon: 'warning',
            title: 'Stock Habis',
            text: 'Maaf, menu ini saat ini tidak tersedia.',
        });
    }
    </script>
</body>
