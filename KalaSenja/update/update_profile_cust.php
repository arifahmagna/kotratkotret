        ...
        <main id="users" class="content-section active">
            ...
            <section class="profile-section">
                <div class="profile-info">
                    <form action="../fungsi/fungsi_update_profile_cust.php" method="POST">
                        <div class="info-item">
                        ...
                        <div class="container-btn" style="display: flex; flex-direction: row; justify-content: space-between;">
                            ...
                            <div class="info-item">
                                <a href="../costumer/cust_profile.php" class="btn" style="text-decoration: none; padding: 8px 20px; cursor: pointer; background-color: white;">Cancel</a>
                            </div>
                        </div>
                    </form>
                </div>
