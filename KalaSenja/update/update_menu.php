...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_FILES['photo']) && $_FILES['photo']['error'] == 0) {
        ...
        if ($stmt = $conn->prepare($sql)) {
            // Bind parameter
            $stmt->bind_param("ssdssii", $menu_name, $price, $desc, $photo, $categoryMenu, $stock, $id);
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            <div class="form-content">
                ...
                <div class="form-group">
                    ...
                    <textarea name="desc" id="desc" rows="4" required><?php echo $menu['desc_tmm']; ?></textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="stock" id="stock" value="<?php echo $menu['stock_tmm']; ?>" required>
                </div>
            </div>
